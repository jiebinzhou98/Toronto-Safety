...
var import_rehackt = __toESM(require_rehackt(), 1);
...
function useSuspenseFragment_(options) {
  ...
  var cache2 = client.cache;
  var id = (0, import_rehackt.useMemo)(function() {
    return typeof from2 === "string" ? from2 : from2 === null ? null : cache2.identify(from2);
  }, [cache2, from2]);
  ...
  var _a2 = import_rehackt.default.useState(fragmentRef === null ? NULL_PLACEHOLDER : [fragmentRef.key, fragmentRef.promise]), current = _a2[0], setPromise = _a2[1];
  import_rehackt.default.useEffect(function() {
    if (fragmentRef === null) {
      return;
    }
